...
In order to use Google Gemini models, you need to have a Google Cloud API key. You can get
one [here](https://developers.generativeai.google/tutorials/setup).

Once you have an API key, you can use it to instantiate a Google Gemini object:
...
In order to use Google Vertexai models, you need to have
...
Once you have basic setup, you can use it to instantiate a Google Vertexai model:
